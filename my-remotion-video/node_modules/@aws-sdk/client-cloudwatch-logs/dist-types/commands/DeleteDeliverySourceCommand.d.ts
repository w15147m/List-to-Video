...
declare const DeleteDeliverySourceCommand_base: {
    new (input: DeleteDeliverySourceCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteDeliverySourceCommandInput, DeleteDeliverySourceCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteDeliverySourceCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteDeliverySourceCommandInput, DeleteDeliverySourceCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
