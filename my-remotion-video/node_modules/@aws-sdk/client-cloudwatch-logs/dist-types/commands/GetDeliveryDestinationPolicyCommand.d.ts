...
declare const GetDeliveryDestinationPolicyCommand_base: {
    new (input: GetDeliveryDestinationPolicyCommandInput): import("@smithy/smithy-client").CommandImpl<GetDeliveryDestinationPolicyCommandInput, GetDeliveryDestinationPolicyCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetDeliveryDestinationPolicyCommandInput): import("@smithy/smithy-client").CommandImpl<GetDeliveryDestinationPolicyCommandInput, GetDeliveryDestinationPolicyCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
