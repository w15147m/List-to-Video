...
declare const DeleteTransformerCommand_base: {
    ...
    new (__0_0: DeleteTransformerCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteTransformerCommandInput, DeleteTransformerCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
