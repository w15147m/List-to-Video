...
declare const GetIntegrationCommand_base: {
    ...
    new (__0_0: GetIntegrationCommandInput): import("@smithy/smithy-client").CommandImpl<GetIntegrationCommandInput, GetIntegrationCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
