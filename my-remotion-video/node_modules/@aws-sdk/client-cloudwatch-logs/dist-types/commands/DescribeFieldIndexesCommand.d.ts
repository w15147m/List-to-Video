...
declare const DescribeFieldIndexesCommand_base: {
    new (input: DescribeFieldIndexesCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeFieldIndexesCommandInput, DescribeFieldIndexesCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DescribeFieldIndexesCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeFieldIndexesCommandInput, DescribeFieldIndexesCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
