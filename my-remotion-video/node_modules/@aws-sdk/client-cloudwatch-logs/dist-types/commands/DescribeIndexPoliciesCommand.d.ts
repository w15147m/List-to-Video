...
declare const DescribeIndexPoliciesCommand_base: {
    new (input: DescribeIndexPoliciesCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeIndexPoliciesCommandInput, DescribeIndexPoliciesCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DescribeIndexPoliciesCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeIndexPoliciesCommandInput, DescribeIndexPoliciesCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
