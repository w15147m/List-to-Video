...
declare const DescribeLogStreamsCommand_base: {
    new (input: DescribeLogStreamsCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeLogStreamsCommandInput, DescribeLogStreamsCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DescribeLogStreamsCommandInput]): import("@smithy/smithy-client").CommandImpl<DescribeLogStreamsCommandInput, DescribeLogStreamsCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
