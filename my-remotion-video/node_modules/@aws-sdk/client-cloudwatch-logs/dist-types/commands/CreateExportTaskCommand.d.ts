...
declare const CreateExportTaskCommand_base: {
    new (input: CreateExportTaskCommandInput): import("@smithy/smithy-client").CommandImpl<CreateExportTaskCommandInput, CreateExportTaskCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateExportTaskCommandInput): import("@smithy/smithy-client").CommandImpl<CreateExportTaskCommandInput, CreateExportTaskCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
