...
declare const DeleteDataProtectionPolicyCommand_base: {
    new (input: DeleteDataProtectionPolicyCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteDataProtectionPolicyCommandInput, DeleteDataProtectionPolicyCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteDataProtectionPolicyCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteDataProtectionPolicyCommandInput, DeleteDataProtectionPolicyCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
