...
declare const GetDeliveryCommand_base: {
    new (input: GetDeliveryCommandInput): import("@smithy/smithy-client").CommandImpl<GetDeliveryCommandInput, GetDeliveryCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetDeliveryCommandInput): import("@smithy/smithy-client").CommandImpl<GetDeliveryCommandInput, GetDeliveryCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
