...
declare const CreateLogAnomalyDetectorCommand_base: {
    new (input: CreateLogAnomalyDetectorCommandInput): import("@smithy/smithy-client").CommandImpl<CreateLogAnomalyDetectorCommandInput, CreateLogAnomalyDetectorCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateLogAnomalyDetectorCommandInput): import("@smithy/smithy-client").CommandImpl<CreateLogAnomalyDetectorCommandInput, CreateLogAnomalyDetectorCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
