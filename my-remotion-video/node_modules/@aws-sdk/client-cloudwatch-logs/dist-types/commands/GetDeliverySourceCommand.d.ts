...
declare const GetDeliverySourceCommand_base: {
    new (input: GetDeliverySourceCommandInput): import("@smithy/smithy-client").CommandImpl<GetDeliverySourceCommandInput, GetDeliverySourceCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetDeliverySourceCommandInput): import("@smithy/smithy-client").CommandImpl<GetDeliverySourceCommandInput, GetDeliverySourceCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
