...
declare const PutDeliveryDestinationPolicyCommand_base: {
    new (input: PutDeliveryDestinationPolicyCommandInput): import("@smithy/smithy-client").CommandImpl<PutDeliveryDestinationPolicyCommandInput, PutDeliveryDestinationPolicyCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: PutDeliveryDestinationPolicyCommandInput): import("@smithy/smithy-client").CommandImpl<PutDeliveryDestinationPolicyCommandInput, PutDeliveryDestinationPolicyCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
