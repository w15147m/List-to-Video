...
declare const DeleteRetentionPolicyCommand_base: {
    new (input: DeleteRetentionPolicyCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteRetentionPolicyCommandInput, DeleteRetentionPolicyCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteRetentionPolicyCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteRetentionPolicyCommandInput, DeleteRetentionPolicyCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
