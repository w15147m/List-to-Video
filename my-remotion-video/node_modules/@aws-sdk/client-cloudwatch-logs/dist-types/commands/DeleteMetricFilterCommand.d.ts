...
declare const DeleteMetricFilterCommand_base: {
    new (input: DeleteMetricFilterCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteMetricFilterCommandInput, DeleteMetricFilterCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteMetricFilterCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteMetricFilterCommandInput, DeleteMetricFilterCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
