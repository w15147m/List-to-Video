...
declare const DescribeQueryDefinitionsCommand_base: {
    new (input: DescribeQueryDefinitionsCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeQueryDefinitionsCommandInput, DescribeQueryDefinitionsCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DescribeQueryDefinitionsCommandInput]): import("@smithy/smithy-client").CommandImpl<DescribeQueryDefinitionsCommandInput, DescribeQueryDefinitionsCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
