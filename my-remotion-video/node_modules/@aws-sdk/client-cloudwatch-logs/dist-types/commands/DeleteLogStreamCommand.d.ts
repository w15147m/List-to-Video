...
declare const DeleteLogStreamCommand_base: {
    new (input: DeleteLogStreamCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteLogStreamCommandInput, DeleteLogStreamCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteLogStreamCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteLogStreamCommandInput, DeleteLogStreamCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
