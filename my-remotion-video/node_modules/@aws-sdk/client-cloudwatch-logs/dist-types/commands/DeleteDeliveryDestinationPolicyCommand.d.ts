...
declare const DeleteDeliveryDestinationPolicyCommand_base: {
    new (input: DeleteDeliveryDestinationPolicyCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteDeliveryDestinationPolicyCommandInput, DeleteDeliveryDestinationPolicyCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteDeliveryDestinationPolicyCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteDeliveryDestinationPolicyCommandInput, DeleteDeliveryDestinationPolicyCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
