...
declare const GetTransformerCommand_base: {
    new (input: GetTransformerCommandInput): import("@smithy/smithy-client").CommandImpl<GetTransformerCommandInput, GetTransformerCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetTransformerCommandInput): import("@smithy/smithy-client").CommandImpl<GetTransformerCommandInput, GetTransformerCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
