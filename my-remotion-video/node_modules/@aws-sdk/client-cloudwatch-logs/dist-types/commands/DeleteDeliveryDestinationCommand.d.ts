...
declare const DeleteDeliveryDestinationCommand_base: {
    new (input: DeleteDeliveryDestinationCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteDeliveryDestinationCommandInput, DeleteDeliveryDestinationCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteDeliveryDestinationCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteDeliveryDestinationCommandInput, DeleteDeliveryDestinationCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
