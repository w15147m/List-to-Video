...
declare const DescribeDeliveryDestinationsCommand_base: {
    new (input: DescribeDeliveryDestinationsCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeDeliveryDestinationsCommandInput, DescribeDeliveryDestinationsCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DescribeDeliveryDestinationsCommandInput]): import("@smithy/smithy-client").CommandImpl<DescribeDeliveryDestinationsCommandInput, DescribeDeliveryDestinationsCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
