...
declare const PutDeliveryDestinationCommand_base: {
    new (input: PutDeliveryDestinationCommandInput): import("@smithy/smithy-client").CommandImpl<PutDeliveryDestinationCommandInput, PutDeliveryDestinationCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: PutDeliveryDestinationCommandInput): import("@smithy/smithy-client").CommandImpl<PutDeliveryDestinationCommandInput, PutDeliveryDestinationCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
