...
declare const GetLogEventsCommand_base: {
    new (input: GetLogEventsCommandInput): import("@smithy/smithy-client").CommandImpl<GetLogEventsCommandInput, GetLogEventsCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetLogEventsCommandInput): import("@smithy/smithy-client").CommandImpl<GetLogEventsCommandInput, GetLogEventsCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
