...
declare const PutDataProtectionPolicyCommand_base: {
    new (input: PutDataProtectionPolicyCommandInput): import("@smithy/smithy-client").CommandImpl<PutDataProtectionPolicyCommandInput, PutDataProtectionPolicyCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: PutDataProtectionPolicyCommandInput): import("@smithy/smithy-client").CommandImpl<PutDataProtectionPolicyCommandInput, PutDataProtectionPolicyCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
