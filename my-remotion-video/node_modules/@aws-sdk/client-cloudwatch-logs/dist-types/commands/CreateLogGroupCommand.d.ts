...
declare const CreateLogGroupCommand_base: {
    new (input: CreateLogGroupCommandInput): import("@smithy/smithy-client").CommandImpl<CreateLogGroupCommandInput, CreateLogGroupCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateLogGroupCommandInput): import("@smithy/smithy-client").CommandImpl<CreateLogGroupCommandInput, CreateLogGroupCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
