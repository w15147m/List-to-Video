...
declare const AssociateKmsKeyCommand_base: {
    new (input: AssociateKmsKeyCommandInput): import("@smithy/smithy-client").CommandImpl<AssociateKmsKeyCommandInput, AssociateKmsKeyCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: AssociateKmsKeyCommandInput): import("@smithy/smithy-client").CommandImpl<AssociateKmsKeyCommandInput, AssociateKmsKeyCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
