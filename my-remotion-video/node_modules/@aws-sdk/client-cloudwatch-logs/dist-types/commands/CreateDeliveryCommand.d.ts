...
declare const CreateDeliveryCommand_base: {
    new (input: CreateDeliveryCommandInput): import("@smithy/smithy-client").CommandImpl<CreateDeliveryCommandInput, CreateDeliveryCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateDeliveryCommandInput): import("@smithy/smithy-client").CommandImpl<CreateDeliveryCommandInput, CreateDeliveryCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
