...
declare const CreateLogStreamCommand_base: {
    new (input: CreateLogStreamCommandInput): import("@smithy/smithy-client").CommandImpl<CreateLogStreamCommandInput, CreateLogStreamCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateLogStreamCommandInput): import("@smithy/smithy-client").CommandImpl<CreateLogStreamCommandInput, CreateLogStreamCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
