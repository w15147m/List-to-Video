...
declare const DescribeSubscriptionFiltersCommand_base: {
    new (input: DescribeSubscriptionFiltersCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeSubscriptionFiltersCommandInput, DescribeSubscriptionFiltersCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DescribeSubscriptionFiltersCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeSubscriptionFiltersCommandInput, DescribeSubscriptionFiltersCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
