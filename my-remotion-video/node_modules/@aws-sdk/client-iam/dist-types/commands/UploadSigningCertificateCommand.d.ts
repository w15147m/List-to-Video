...
declare const UploadSigningCertificateCommand_base: {
    new (input: UploadSigningCertificateCommandInput): import("@smithy/smithy-client").CommandImpl<UploadSigningCertificateCommandInput, UploadSigningCertificateCommandOutput, IAMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UploadSigningCertificateCommandInput): import("@smithy/smithy-client").CommandImpl<UploadSigningCertificateCommandInput, UploadSigningCertificateCommandOutput, IAMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
