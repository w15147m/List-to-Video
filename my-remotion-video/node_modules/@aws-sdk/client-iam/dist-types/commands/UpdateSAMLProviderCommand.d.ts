...
declare const UpdateSAMLProviderCommand_base: {
    new (input: UpdateSAMLProviderCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateSAMLProviderCommandInput, UpdateSAMLProviderCommandOutput, IAMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateSAMLProviderCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateSAMLProviderCommandInput, UpdateSAMLProviderCommandOutput, IAMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
