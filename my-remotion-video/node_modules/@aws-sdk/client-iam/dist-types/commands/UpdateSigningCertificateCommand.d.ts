...
declare const UpdateSigningCertificateCommand_base: {
    new (input: UpdateSigningCertificateCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateSigningCertificateCommandInput, UpdateSigningCertificateCommandOutput, IAMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateSigningCertificateCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateSigningCertificateCommandInput, UpdateSigningCertificateCommandOutput, IAMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
