...
declare const UpdateServerCertificateCommand_base: {
    new (input: UpdateServerCertificateCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateServerCertificateCommandInput, UpdateServerCertificateCommandOutput, IAMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateServerCertificateCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateServerCertificateCommandInput, UpdateServerCertificateCommandOutput, IAMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
