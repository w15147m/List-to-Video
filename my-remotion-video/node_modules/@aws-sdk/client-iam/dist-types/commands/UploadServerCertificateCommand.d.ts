...
declare const UploadServerCertificateCommand_base: {
    new (input: UploadServerCertificateCommandInput): import("@smithy/smithy-client").CommandImpl<UploadServerCertificateCommandInput, UploadServerCertificateCommandOutput, IAMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UploadServerCertificateCommandInput): import("@smithy/smithy-client").CommandImpl<UploadServerCertificateCommandInput, UploadServerCertificateCommandOutput, IAMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
