...
declare const UploadSSHPublicKeyCommand_base: {
    new (input: UploadSSHPublicKeyCommandInput): import("@smithy/smithy-client").CommandImpl<UploadSSHPublicKeyCommandInput, UploadSSHPublicKeyCommandOutput, IAMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UploadSSHPublicKeyCommandInput): import("@smithy/smithy-client").CommandImpl<UploadSSHPublicKeyCommandInput, UploadSSHPublicKeyCommandOutput, IAMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
